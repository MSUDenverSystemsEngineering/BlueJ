...
Try {
	...
	[string]$appVendor = 'BlueJ.org'
	[string]$appName = 'BlueJ'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'BlueJ' -CheckDiskSpace -PersistPrompt
		...
		Execute-MSI -Action Uninstall -Path '{AF0BEA9E-1AB2-4613-A6B5-4ECC105A8A23}' -PassThru -ContinueOnError $true
		Execute-MSI -Action Uninstall -Path '{8C92BA41-F0FF-4ECA-98D2-E6F0C013A4DB}' -PassThru -ContinueOnError $true
		Execute-MSI -Action Uninstall -Path '{93E05243-FD0A-4792-870A-C830372771AD}' -PassThru -ContinueOnError $true
		...
		$exitCode = Execute-MSI -Action "Install" -Path "$dirFiles\BlueJ-windows-510.msi" -Parameters "/qn" -PassThru
		...
		If (Test-Path "$envUserStartMenuPrograms\BlueJ") {
            Copy-Item "$envUserStartMenuPrograms\BlueJ" -Destination "$envCommonStartMenuPrograms" -Recurse
        }

		If (Test-Path "$envUserStartMenuPrograms\BlueJ") {
			Remove-Item "$envUserStartMenuPrograms\BlueJ" -Force -Recurse
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'bluej' -CloseAppsCountdown 60
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		Execute-MSI -Action "Install" -Path "$dirFiles\BlueJ-windows-510.msi" -Parameters "/qn" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBYzDIHKF9bVTwN
# 8qmjlw+ugMjIGKT7mRR5G+nyDBTP46CCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC6HyRD79q07jH4
# aSAX4sHv+LdcoE0YCHC0VNrDCo4M0zANBgkqhkiG9w0BAQEFAASCAYA47KFgfQmH
# XpXY63n75A8c+w4pfuiMpmbmDOPVRvIZNUsyXohi+UckcpeKuWBJSf4llC15PN+M
# Q3wGrkb3Vvln3UB9q14jJDc/iKHLted6itHO6UCXe0ugmsl/9YAWZmMKU3laQmir
# v/1r4t4GEOUU13UyweT7CrqB49jlpOzheGd5iodwoe4jnXjhxE/c5XCzRwAgGdmI
# g/Xh4h5mUuAeXAtBGwN9VAO8SA3mOgOqgyKnF5iA7Kx23QKHX2GkP+K1agShssEA
# z0pNoTUGBnO4hTS8u0TK6U1iwUOiIt8LDnEiL6AdmKIaAp/UuH6dj5zzJtscwvgp
# C4oy43WsJH2VWeR8ddcwsc/fp6Z4V9VkjzsbYb+RmgFxkRTHfJrTgWRNWmTI0aVP
# KBcUcgKEd7MGGwlgRtHqtZltf9DtiMzl2yvIzYXzWmadG0QHqkh0m2G0Hg3xwjJI
# cL7cQhBwUOqTJcd+Yt60B65kgSRi/bsQBoUlhANEMjVqdOjlzew8gsmhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNjAxMjIw
# ODE1WjA/BgkqhkiG9w0BCQQxMgQwNKO5Nqxc0Dz65FBciYgsuNMknOJtBrybBSBC
# xt/r3ps935PlhV5wweAOoj4HBOlLMA0GCSqGSIb3DQEBAQUABIICACrymGSCuD7w
# 2rWhghvOrzARO30pHRQzRlsimfFi+6T4NW2cBpMF0EavRjN33Dw4n26H6eHz3cbp
# 5WUPXJnfdNioCx+K9eG4M8TZ3X9HNJq6K773SV/5n5eTWRrgcudmZfZxzhBr+hSz
# KefiCaLXRhomhjU+4K+DSMog4CQumbA7TOSjjZiHVjKjjRItL/sHBWHHvUZCzEv3
# WCTxte6WyYhihXOjmEhJ7FxuT85sNtmVC+t+ga3KF0T/WRGTvsK5YD+zwZUZoIP0
# tM06fZQD8rCLxzs4tdqAF0DlyErH61JAYwSFW4M9Y21CENLPmFfF3N1BsEeBscqR
# FY1OYoJReOgFwPsx4uTSjXyRnNFBSBtdYhIERED5oKUsnVJ6pUIMCLRPX8kFhMJc
# wFsaOoiIvk8zkg8k1OJF/BjF19UOF/3V52MlBtMYevbaGuhNuHXecmJ7WVV2Vrx+
# 9cMJpgjP+3iFJnJuWuCpM0QQEPYn0P/7vh1D8dq60bFgYH9wKoeKxrvb4qzbl/x5
# nVHLIAzPZHy7ptBgGAEYY8j6uCsr/zeV3HcuSW++3bJ1DZvzq5DpI1ctRHx+BdsN
# A9K5BMpnho3aUh64XExifzTZRnW40RTRZwaN6aS8xuKELmAZEDI4xqLDkR58/DzM
# 2Ssy1MsT9RigG2EMMWOiyCqke5HhavJe
