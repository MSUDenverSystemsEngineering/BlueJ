...
Try {
	...
	[string]$appVersion = '5.0.1'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '05/13/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action "Install" -Path "$dirFiles\BlueJ-windows-501.msi" -Parameters "/qn" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		Execute-MSI -Action Uninstall -Path '{39F0200A-540D-43C5-A845-6D51BA794175}' -PassThru -ContinueOnError $true
		Start-Sleep -Seconds 30
		Execute-MSI -Action "Install" -Path "$dirFiles\BlueJ-windows-501.msi" -Parameters "/qn" -PassThru
